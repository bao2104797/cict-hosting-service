...
public class ProjectFrontendEntity {
    ...
    @Column(name = "max_replicas", nullable = true)
    ...
    @OneToMany(mappedBy = "frontend", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<FrontendRequestEntity> requests = new ArrayList<>();
